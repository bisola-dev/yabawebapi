...
$baba = mysqli_query($conn, "SELECT * FROM subject ORDER BY subjects ASC"); 
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>OLEVEL SUBJECT LIST</h1>
                  <small>Add and Delete subject.</small>
               </div>
            </section>
            <!-- Main content -->
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action="">
                            <div class="form-group ">
                              ...
                              <input type= "submit"  name="add" value="ADD SUBJECT"> <br>  <br>
                           </form>
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                     ...
                                     <?php 
                                     $count = 1;
                                    while ($row = mysqli_fetch_assoc($baba)) {
                                       $id = $row['id'];
