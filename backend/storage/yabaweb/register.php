 ...
 //Check if account already exists
  ...
  $reportalert='<script type="text/javascript">
     ...
     $loga = mysqli_query($conn, "INSERT INTO logger (uzer, activity, timereg) VALUES ('$emal', 'Registered as fresh applicant', '$date_reg')"); 
      ...
      $insert= "INSERT INTO applicants (fulln, emal, fon, pwd, hpwd, prog, course, dreg) VALUES ('$fulln', '$emal', '$fon', '$pwd', '$hpwd', '$prog', '$course', '$date_reg')";
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                 ...
                                 <select type="text" name="course" class="form-control">
                                     <option value="select">Click to select</option>
                                    <?php 
                                     $cos = mysqli_query($conn,"SELECT * FROM courses");
