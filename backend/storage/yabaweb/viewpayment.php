...
$baboon = mysqli_query($conn, "SELECT * FROM payment");
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    $count = 0;
                                    $sum = 0;
                                    while ($opay= mysqli_fetch_assoc($baboon)) { 
                                       $name = $opay['name'];
                                       $emal = $opay['emal'];
                                       $session = $opay['session'];
                                       $payme = $opay['paymdate'];
                                        $amount = $opay['amount']; 

                                        $olodo = mysqli_query($conn, "SELECT * FROM applicants WHERE emal = '$emal'");

                                  while ($row=mysqli_fetch_assoc($olodo)) {
                                    $course = $row['course'];
                                    $prog= $row['prog'];
                                    $procos=$course.' '.$prog;
                                    $count++;
                                    ...
                                    <tr>
                                       <th><?php echo $count;?></th>
                                        <th><?php echo $name; ?></th>
                                       <th><?php echo $emal; ?></th>
                                       <th><?php echo $procos; ?></th>
                                       <th><?php echo $session;?></th>
                                       <th><?php echo $payme; ?></th>
