...
<head>
    ...
    <body>
        ...
        <div class="lock-wrapper-page">
            ...
            <form method="post" action="applicantlogin.php" class="text-center m-t-20">
                <div class="user-thumb">
                    <img src="imagez/<?php echo'def.jpg' ?>" class="img-responsive img-circle img-thumbnail" alt="thumbnail">
                </div>
                ...
                <div class="text-center">
                    <a href="index.php" class="text-muted">Back to Home Page</a>
                </div>
            </form>
        </div>
        <!-- /.content-wrapper -->
