...
$sql = mysqli_query($conn, "SELECT * FROM applicants WHERE fulln ='$fulln'");
...
/* 
//echo $emal.''.$fon.''.$fulln.''.$pwd.''.$rpwd.''.$prog.''.$mkode.''.$hpwd.''.$course.''.$statuz;

$check = mysqli_query($conn, "SELECT * FROM applicants ");
...
while ($row=mysqli_fetch_assoc($check)) {
  ...
  window.Location.href='editapplicantbiodata.php';
  </script>";
  ...
  else if($Fullname!= $fulln){
        $reportalert='<script type="text/javascript">
        alert("The name does not exist in the database. Please retry.");
          window.Location.href="editapplicantbiodata.php";
        </script>';
         } 
...
*/
 ...
 $new = mysqli_query($conn," UPDATE  applicants SET emal='$emal', fon='$fon', prog='$prog',course='$course',  statuz='$statuz' WHERE fulln='$fulln'"); 
     $reportalert='<script type="text/javascript">
        alert("Your biodata has been updated successfully.");
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              <a class="btn btn-add " href="editapplicantbiodata.php"> 
                        ...
                        <div class="panel-body">
                           <form action="" method="post">                              
                             <div class="form-group ">
                                    ...
                                    <input type="text" value="<?php echo $fulln_db; ?>" id="username" class="form-control" name="fulln">
                                  
                                </div>

                                <div class="form-group ">
                                    <label>Email</label>
                                    <input type="text" value="<?php echo $emal_db; ?>" id="email" class="form-control" name="emal">
                                  
                                </div>

                                 <div class="form-group ">
                                    <label>phone</label>
                                    <input type="text" value="<?php echo $fon_db; ?>" id="phone no" class="form-control" name="fon">
                                 ...
                                 <div class="form-group" >
                                    ...
                                    <option value="<?php $course_db; ?>"> <?php $course_db; ?> </option>  
                                 <?php 
                                  ...
                                  ?>
                                    <option value="<?php echo $course_db;?>"><?php echo $course_db;?></option> 
                                      <?php } ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <select class="form-control" name="prog">
                                     <option value="<?php echo $prog_db;?>"><?php echo $prog_db;?></option>
                              ...
                              <div class="reset-button">
                                 ...
                                 <button type="submit" name ="submit" class="btn btn-add">UPDATE</a>
                              </div>
                           </form>
                        </div>
                     </div>
