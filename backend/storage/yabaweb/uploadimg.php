...
$deany = mysqli_query($conn, "SELECT * FROM payment WHERE emal= '$sesmail'");
$num_rows = mysqli_num_rows($deany);
if ($num_rows > 0){ 
// do not insert
$reportalert = "<script type ='text/javascript'>
            alert('You have already uplpaded your passport')
...
$new = "UPDATE applicants SET pix = '$fileName' WHERE emal = '$sesmail'";
