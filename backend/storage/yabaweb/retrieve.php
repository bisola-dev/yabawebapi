...
<head>
        ...
        <title>Retrieved Password : BOS Academy</title>
    ...
    <body>
        ...
        <div class="lock-wrapper-page">
            ...
            <form method="post" action="login.php" class="text-center m-t-20">
                ...
                <div class="form-group">
                    ...
                    <p class="text-muted">Your passsword is OMOsolaB2019@</p>
