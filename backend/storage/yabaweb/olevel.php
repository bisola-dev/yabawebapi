...
$sit = mysqli_real_escape_string($conn, $_POST['sit']);
  ...
  window.location.href='olevel.php';
  </script>";
   }
      else if ($sit==1) {
            header("Location:olevelreg1.php");
         }
         else{
            header("Location:olevelreg2.php");
         }
      }
