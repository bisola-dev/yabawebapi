...
if (isset($_POST['submit'])){
   ...
   if($examnum == "" || $examyear== "" ||$examtype == ""|| $subject1== "" || $grading1== ""|| $subject2 == ""|| $grading2== ""||$subject3== "" || $grading3== ""||$subject4== "" || $grading4== ""||$subject5 == "" || $grading5 == "" || $subject6 == "" || $grading6 == ""||$subject7 == "" || $grading7 == "" || $subject8 == "" || $grading8 == ""||$subject9 == "" || $grading9 == "" ){
  
   
  $reportalert="<script type ='text/javascript'>
  alert('please do not submit empty form.')
  window.location.href='olevelreg.php';
  </script>";

   }else {         

      $lintin = mysqli_query($conn, "INSERT INTO examdeets (sitting,studentid,examtype,examyear,examnum,dreg,emal) VALUES('$sitting','$plicantid','$examtype','$examyear','$examnum','$dreg','$plicantmail')");

         
  $new = mysqli_query($conn, "SELECT * FROM examdeets WHERE emal='$plicantmail'");
                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form class="col-sm-6" method="POST" action="">
                              ...
                              <div class="header-title">
                                <h5 align="center"><b> Select your Subjects and Grades</b></h5>
                               </div>
                              <div class="row">
                              ...
                              <br/> <br/>
                                    <div class="btn-group" id="buttonlist">
                             <h4><i>Please fill the second sitting carefully</i></h4>
                           </div>
                                 <br/> <br/>
                                 <div class="form-group">
                                 <label>Exam Type</label>
