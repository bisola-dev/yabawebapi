...
if (isset($_POST['addn'])){
   $gradn = trim(strip_tags($_POST['gradn']));
...
if (mysqli_query($conn, $grademe )) {
  $reportalert='<script type="text/javascript">
    ...
    $reportalert='<script type="text/javascript">
        alert("subjected unadded please retry.");
         window.location.href="addgrade.php";
        </script>';
         }
      }
...
if(isset($_POST["deletey"])){
 $delid=trim(strip_tags($_POST['delid']));
 

// sql to delete a record
$sqly = "DELETE FROM grades WHERE id = $delid";
...
$babami = mysqli_query($conn, "SELECT * FROM grade ORDER BY grades ASC"); 
                        ...
                        <div class="panel-body">
                           ...
                           <form method="POST" action="">
                            <div class="form-group ">
                              ...
                              <input type="text"  id="grade" class="form-control" name="gradn" >
                            </div>
                              <input type= "submit"  name="addn" value="ADD GRADE"> <br>  <br>
                           </form>
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                     ...
                                     <?php 
                                     $count = 1;
                                    while ($row = mysqli_fetch_assoc($babami)) {
                                       $id = $row['id'];
                                       $grade = $row['grades'];
                                    ?>
                                    ...
                                    <p><input type="submit" name="deletey" value="delete grade"> </p>
                                       </td>
                                    <?php $count++;} ?>
