...
$dean = mysqli_query($conn, "SELECT * FROM payment WHERE emal= '$sesmail'");
$num_rows = mysqli_num_rows($dean);
if ($num_rows > 0){ 
// do not insert
$reportalert = "<script type ='text/javascript'>
            alert('You have already made payment')
             window.location.href='printreceipt.php';
             </script>";           
}        
else{

   $pepe = mysqli_query($conn, "SELECT *  FROM app WHERE csesion=1"); 
       while($row=mysqli_fetch_assoc($pepe)){
             $fee = $row['fee'];
             $closindate = $row['closindate'];
             $sesion = $row['sesion'];
  

      $sesfee = $_SESSION['fee'] = $fee;
      $csession = $_SESSION['sesion'] = $sesion;
...
<!-- Mirrored from thememinister.com/crm/paysetting.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2019 13:29:16 GMT -->
<head>
      <meta charset="utf-8">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1><?php echo $sesfulln;?>, Application Payment</h1>
                  <small>Payment for Application</small>
               </div>
            </section>
            <!-- Main content -->
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Pay for ONLINE Application</h4>
                              </a>
                           </div>
                        </div>
 ...
 <h4> THE APPLICATION FEE FOR <?php echo $sesion;?> ACADEMIC SESSION IS ₦<?php echo $fee;?>. PLEASE NOTE THE CLOSING DATE FOR PAYMENT REMAINS <?php echo $closindate;?>.
              
                                 </div>
                             
                              <div class="reset-button text-center">
                                 <button><a href= "cardetails.php" class="btn btn-warning">PAY</a></button>
                              </div>
