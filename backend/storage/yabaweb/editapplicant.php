...
if (isset($_POST['submit'])){
 ...
 window.location.href='editapplicant.php';
 </script>";
...
$querxy = mysqli_query($conn, "UPDATE  applicants SET fulln='$fullnn', fon='$fonn', course='$coursen', prog='$progn' WHERE id =$candid2");
 ...
 $reportalert= '<script type="text/javascript">
        alert("Record successfully edited and saved.");
        </script>';
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1> Edit Applicants    :: <div class= "redtext" ><?php if (!empty($reportalert)){echo $reportalert;}?></div></h1>
