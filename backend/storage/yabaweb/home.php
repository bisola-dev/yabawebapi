            ...
            <nav class="navbar navbar-static-top">
             ...
             <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <!-- user -->
                     <?php 
                     $kay = mysqli_query($conn, "SELECT * FROM applicants WHERE emal ='sesmail'");
                     while($row=mysqli_fetch_assoc($kay)){ 
                        $seid = $row['id'];
                        $emal = $row['emal'];
                        $pix = $row['pix'];
                        $join = 'uploadimg.php?id='.$seid;
