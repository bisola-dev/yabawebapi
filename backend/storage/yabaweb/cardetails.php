...
if (isset($_POST['submit'])){
 ...
 $payment= mysqli_query($conn, "INSERT INTO payment (name, emal, prog, course, session, paymdate, amount) VALUES('$sesfulln', '$sesmail', '$sesprog', '$sescourse', '$session1', '$date_reg', '$appfee1')");
