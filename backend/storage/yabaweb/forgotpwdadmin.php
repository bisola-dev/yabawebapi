...
if (isset($_POST['submit'])){
   $currentpwd = trim(strip_tags($_POST['currentpwd']));
      $newpwd = md5(trim(strip_tags($_POST['newpwd'])));
      $cnewpwd = md5(trim(strip_tags($_POST['cnewpwd'])));
  ...
  window.location.href='changepwdadmin.php';
         ...
         $reportalert="<script type ='text/javascript'>
  alert('New password and confirm new pssword do not tally');
  window.location.href='changepwdadmin.php';
  </script>";
      }
    ...
    $rows = mysqli_num_rows($bless);
      ...
      if ($hpwd == $pwd_db){
         ...
         if ($newpwd==$cnewpwd){
           ...
           if (mysqli_query($conn, "UPDATE adminlogin SET hash='$newpwd' WHERE usemail='$sesmail'")){
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" method = "post" action = "">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="currentpwd" class="form-control" placeholder="Enter Password details" required>
                              </div>
                              <div class="form-group">
                                 <label>New Password</label>
                                 <input type="text" name="newpwd" class="form-control" placeholder="Enter New Password details" required>
                              </div>
                              <div class="form-group">
                                 <label>Confirm New Password</label>
                                 <input type="text" name="cnewpwd" class="form-control" placeholder="Enter Confirm New Password details" required>
                              </div>
