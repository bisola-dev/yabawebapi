                  ...
                  <div class="col-sm-12">
                                             ...
                                             <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> Upload Image caption </a>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($know as $data)  
                           ...
                           <h5 class="modal-title">Upload Image Caption </h5>
