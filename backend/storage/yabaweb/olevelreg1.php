...
if (isset($_POST['submit'])){
   //mysqli_real_escape_string($con,$_POST["pass1"]);
      ...
      $examyear =trim(strip_tags($_POST['examyea']));
  ...
  window.location.href='olevelreg1.php';
      ...
      $lintin = mysqli_query($conn, "INSERT INTO examdetails (sitting, aplikantid, examtype, examsesion, examyear, examnum, dreg,aplikantmail) VALUES('$sitting','$aplikantid', '$examsesion', $examtype','$examyear','$examnum','$dreg','$sesmail')");
 ...
 $newme = mysqli_query($conn, "INSERT INTO subgrade (resultid,aplikantid,subject1,gradn1,subject2,gradn2,subject3,gradn3,subject4,gradn4,subject5,gradn5,subject6,gradn6,subject7,gradn7,subject8,gradn8,subject9,gradn9) VALUES ('$resultid','$aplikantid', '$subject1','$grading1', '$subject2','$grading2','$subject3','$grading3','$subject4','$grading4','$subject5','$grading5', '$subject6','$grading6', '$subject7','$grading7', '$subject8','$grading8', '$subject9','$grading9')");
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" method="POST" action="">
                              <div class="form-group">
                                 ...
                                 <select type="text" name="examtype" class="form-control">
                              ...
                              <div class="form-group">
                                 <label>Exam session/month</label>
                                 <select type="text" name="examsesion" class="form-control">
                                    <option value="select">Click to select</option>
                              ...
                              <div class="form-group">
                                 ...
                                 <select type="text" name="examyea" class="form-control">
                                    <option value="select">Click to select</option>
                                    <?php 
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="examnum" placeholder="Enter registration number" required>
                              </div>
                              ...
                              ?>
                                ...
                                <div class="form-group col-lg-6">
                                 <label>Grade</label>
                                 <select type="text" name="grading" class="form-control">
                                    <option value="select">Click to select</option>
                                    <?php 
