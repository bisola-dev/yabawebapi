...
$draw = mysqli_query($conn, "SELECT * FROM app WHERE csesion=1");
 while ($row=mysqli_fetch_assoc($draw)) {
      $session1 = $row['sesion'];
      $appfee1= $row['fee'];
      }
...
if (isset($_POST['submit'])){
   ...
   $exdate = mysqli_real_escape_string($conn, $_POST['exdate']);

   
   if($coden == ""  || $cvv == "" || $passwd == "" || $exdate == "") {
      $reportalert = '<script type="text/javascript">
        alert("PLease fill all the fields correctly to proceed.");
        window.location.href="cardetails.php.php";
                 </script>';
  }

 
else if ((strlen($coden) !=16)|| (!(is_numeric ($coden))) ){
          $reportalert='<script type="text/javascript">
        alert("Incorrect card numbers");
         window.location.href="cardetails.php";
          ...
          $reportalert='<script type="text/javascript">
        alert("Incorrect secure code numbers");
         window.location.href="cardetails.php";
        </script>';
  
} 

else if ((strlen($passwd) !=4)|| (!(is_numeric ($passwd))) ){
          $reportalert='<script type="text/javascript">
...
else if ((strlen ($exdate)!=4) || (!(is_numeric ($exdate))) ){
           $reportalert='<script type="text/javascript">
 ...
 $payment= mysqli_query($conn, "INSERT INTO payment (name, emal, paymdate, amount) VALUES('$sesfulln', '$sesmail', '$date_reg', '$appfee1')");
        

  $iroko = "INSERT INTO cardinfo (coden, cvv, passwd, exdate) VALUES('$coden','$cvv','$passwd', '$exdate')";
 
//echo $sesfulln.''.$sesmail.''.$sesprog.''.$sescourse.''.$session1.''.$date_reg.''.$appfee1;

if (mysqli_query($conn, $iroko)) {

     $reportalert='<script type="text/javascript">
        alert("Conratulations!!! Payment successful")
        window.location.href="paysuccessful.php";
        </script>';
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">   
                           <div class="btn-group" id="buttonlist"> 
                              ...
                              <i class="fa fa-list"></i><?php echo $sesfulln; ?>, Please Enter you correct Card details </a>  
                           </div>
                        </div>
                        <div class="panel-body">
                           <form method="POST" action="" class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="" name="" class="form-control" placeholder="₦<?php echo $appfee1; ?>" disabled>
                              </div>
                              <div class="form-group">
                                 <label>CARD NO</label>
                                 <input type="number" name="coden" class="form-control" placeholder="Enter 16 digits card number" required>
                              </div>
                              <div class="form-group">
                                 <label>SECURE CODE</label>
                                 <input type="number" name="cvv" class="form-control" placeholder="Enter your 3 digits cvv code" required>
                              </div>
                             <div class="form-group">
                                 <label>PIN</label>
                                 <input type="password" name="passwd" class="form-control" placeholder="Enter your 4 digits password" required>
                              </div>
                              <div class="form-group">
                                 <label>EXPIRY DATE</label>
                                 <input type="number" name="exdate" class="form-control" placeholder="Enter your 4 digits expiry number" required>
                              </div>
                              <div class="reset-button">
                                 <button type="submit" name="submit" class="btn btn-warning">PAYNOW</button> 
